...
export default function MetaTags() {
  return (
    <>
      ...
      <meta property="og:url" content="https://resources.clevers.co.ke/" />
      ...
      <meta property="twitter:domain" content="resources.clevers.co.ke" />
      <meta property="twitter:url" content="https://resources.clevers.co.ke/" />
