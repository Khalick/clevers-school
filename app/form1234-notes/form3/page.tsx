...
const ROUTE = '/form1234-notes/form3';
        ...
        <ResourceBrowser
            source={{
                ...
                folders: [
                    ...
                    { id: '13tPjQrotqG-jeaE8bPgQs-VT-pPKol4n', label: 'IRE' },
                    { id: '1xdH_-XMcSbo7pVBMBjRlOJaish5t2XF1', label: 'Home Science' },
                    { id: '1gRMk5GfWYNSvgIq16y-IG-1Le5Lm8TJ-', label: 'History' },
                    { id: '1TWVUdQx279nEjplnC-J8VRfvzWGkM1Mx', label: 'Geography' },
