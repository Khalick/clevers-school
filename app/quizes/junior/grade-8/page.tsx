...
// Constants
const FOLDER_ID = '18zP4vYrqmyZbatJyggciN4QySM0t1l7C';
...
const LoadingSpinner = () => (
    <div className="h-full flex items-center justify-center bg-yellow-400" role="status">
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 min-w-0">
                <h3 className="text-sm md:text-base font-medium text-black text-wrap group-hover:text-emerald-300 truncate">
                    {file.name}
                </h3>
                {file.lastModified && (
...
// Main Component
export default function Grade8Exams() {
    ...
    return (
        <div className="flex flex-col h-full overflow-hidden w-full">
            <div className="flex-1 overflow-y-auto px-4 py-8 bg-yellow-400">
